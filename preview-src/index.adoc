...
:url-enterprise: http://www.cemosis.fr/math-entreprise/
:enterprise: {url-enterprise}[ENTERPRISE COLLABORATION]
:url-multidisciplinary: http://www.cemosis.fr/multi-disciplinary/
:multidisciplinary: {url-mutidisciplinary}[MULTIDISCIPLINARY COLLABORATION]
